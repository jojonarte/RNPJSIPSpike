                ...
                <View style={s.listContainer}>
                    ...
                    <View style={{bottom: 15, right: 15, alignSelf: 'flex-end', alignItems: 'flex-end', flex: 0}}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            <TouchableHighlight onPress={() => dispatch(Navigation.goTo({name: 'dialer'}))}>
                                <View style={{borderRadius: 52, backgroundColor: "#FF5252", width: 52, height: 52, justifyContent: 'center'}}>
                                    <Text style={{alignSelf: 'center', color: "#FFF"}}>Call</Text>
                                </View>
                            </TouchableHighlight>
                            {/*<TouchableHighlight onPress={() => dispatch(Navigation.goTo({name: 'new_account'}))}>
                                <View style={{borderRadius: 52, backgroundColor: "#CFD8DC", width: 52, height: 52, justifyContent: 'center'}}>
